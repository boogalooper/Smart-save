...
var strParent= {en:"Folder", ru: "Папка"}
var strParentOfParent= {en:"Parent of folder", ru: "Каталог папки"} //
...
var strSubfolder = {en:"Subfolder", ru: "Подкаталог"} 
...
function collectSubfolderSettings (parent)
{
    ...
    for (var i=1; i<parent.children.length; i++)
    {
        ...
        else {exportInfo.subFolderOpt=s}
...
function initMetadata (metadata)
{
        ...
        try {var tmp = doc.path.fsName; tmp = tmp.split(sysDiv); metadata.parentOfParentPath=tmp[tmp.length-2]} catch (e) {metadata.parentOfParentPath = ""}  //parent of parent
